    ...
    <div class="row" style="font-size: 18px;">
        <div class="col-sm-12">
            ...
            <table class="table table-striped table-light table-bordered">
                ...
                <?php
                $select_debit = $ctr_debit->viewDebit();
    ...
    <div class="row">
        <div class="col-12 text-center">
            <form action="" method="post">
                ...
                <a href="../print/director/index_s.php?invoice_no=<?php echo $ctr_sales->viewSales("invoice_no"); ?>" class="btn btn-success d-print-none">Print Retail</a>
