            ...
            <div class="card">
                ...
                <div class="card-body table-responsive p-0 fixTableHead">
                    <table class="table table-hover">
                        ...
                        <tbody id="table">
                            <?php
                            $select = $ctr->displayEachReturnGoods();
...
<script>
    function availableName(customer_name) {
        ...
        xhttp.open("GET", "../../extra/return_goods/each_return_customer_name.php?customer_name=" + customer_name, true);
        xhttp.send();
    }
    ...
    function availableAddress(customer_address, customer_name) {
        ...
        xhttp.open("GET", "../../extra/return_goods/each_return_customer_address.php?customer_address=" + customer_address + "&customer_name=" + customer_name, true);
        xhttp.send();
    }
    ...
    function availableInvoiceNo(invoice_no) {
        ...
        xhttp.open("GET", "../../extra/return_goods/each_return_invoice.php?invoice_no=" + invoice_no, true);
        xhttp.send();
    }
</script>
<?php
