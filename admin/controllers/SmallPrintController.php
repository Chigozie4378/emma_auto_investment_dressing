...
class SmallPrintController extends Controller
{
    ...
    public function showPosInvoice($invoice_no)
    {
        return $this->fetchWhereAnd("pos", "invoice_no = $invoice_no");
    }

    public function showInvoiceSales($invoice_no)
    {
        return $this->fetchWhereAnd("sales", "invoice_no = $invoice_no");
    }

    public function showInvoiceSalesDetails($invoice_no)
    {
