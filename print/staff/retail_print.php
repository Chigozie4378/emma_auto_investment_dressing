...
if (isset($_SESSION["invoice_no"])) {
    ...
    $select_pos = $ctr->showPosInvoice($_SESSION["invoice_no"]);
    $result_pos = mysqli_fetch_array($select_pos);
    $select = $ctr->showInvoiceSales($_SESSION["invoice_no"]);
    ...
    <body>
        ...
        <span style="font-weight: bolder;">Tel: </span>07063684266, 08062063060</p><br> </p>
    ...
    $select = $ctr->showInvoiceSalesDetails($_SESSION['invoice_no']);
    ...
    header("location:../../staff/views/retail.php");
}
